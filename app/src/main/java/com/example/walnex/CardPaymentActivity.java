...
public class CardPaymentActivity extends AppCompatActivity {
    ...
    private void bindCardData() {
        ...
        String maskedNumber = intent.getStringExtra(EXTRA_MASKED_NUMBER);
    ...
    private void setupQrPayButton() {
        ...
        if (btnQrPay != null) {
            btnQrPay.setOnClickListener(v ->
                    Toast.makeText(this, "QR Pay – coming soon", Toast.LENGTH_SHORT).show());
        }
    }
}